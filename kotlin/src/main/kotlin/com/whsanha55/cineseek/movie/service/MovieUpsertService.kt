...
import com.whsanha55.cineseek.movie.domain.MovieCast
import com.whsanha55.cineseek.movie.domain.MovieDirector
	...
	fun upsert(m: TmdbMovie): Long {
		...
		m.genres.forEach { g ->
			val genre = genreRepository.findById(g.genreId)
				.orElseGet { genreRepository.save(com.whsanha55.cineseek.movie.domain.Genre(g.genreId, g.name)) }
			saved.genres += genre
		}
